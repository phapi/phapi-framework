...
class GoneTest extends \PHPUnit_Framework_TestCase
{
    ...
    public $errorMessage = 'This resource is gone. Used to indicate that an API endpoint has been turned off. For example: "The REST API v1 will soon stop functioning. Please migrate to API v1.1."';
